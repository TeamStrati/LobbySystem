...
public class bewerben implements CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        if (sender instanceof Player) {
            ...
            String Message1 = yamlConfiguration.getString("Application.Message");
            String Message2 = yamlConfiguration.getString("Application.Message2");
            String HoverMessage = yamlConfiguration.getString("Application.HoverMessage");
            String link = yamlConfiguration.getString("Application.Link");
