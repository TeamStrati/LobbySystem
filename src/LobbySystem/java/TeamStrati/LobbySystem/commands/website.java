...
public class website implements CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        if (sender instanceof Player) {
            ...
            String Message1 = yamlConfiguration.getString("Website.Message");
            String Message2 = yamlConfiguration.getString("Website.Message2");
            String HoverMessage = yamlConfiguration.getString("Website.HoverMessage");
            String link = yamlConfiguration.getString("Website.Link");
