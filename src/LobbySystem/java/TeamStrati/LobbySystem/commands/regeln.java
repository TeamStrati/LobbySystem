...
public class regeln implements CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        if (sender instanceof Player) {
            ...
            String Message1 = yamlConfiguration.getString("Rules.Message");
            String Message2 = yamlConfiguration.getString("Rules.Message2");
            String HoverMessage = yamlConfiguration.getString("Rules.HoverMessage");
            String link = yamlConfiguration.getString("Rules.Link");
